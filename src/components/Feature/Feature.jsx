const Feature = () => {
  return (
    <div  className="bg-[#f3f4f6] py-1">
      <div className="container my-24 mx-auto md:px-6">
        <section className="mb-32">
        <h1 className="text-6xl font-bold text-[#010103]">
          Explore Our <span className="text-[#ff5030]">Services</span>
        </h1>
          ...
          <div className="flex flex-wrap items-center">
            <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-6 lg:mb-0 lg:w-5/12">
              ...
              >
                <img
                  src="https://cloudfront-us-east-2.images.arcpublishing.com/reuters/U6DU4EGVOZNXPHXTMIPF7B5C64.jpg"
                  className="w-full"
                />
                <a href="#!">
                  <div className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-[hsl(0,0%,0%,0.4)] bg-fixed">
                    <div className="flex h-full items-center justify-center">
                      <div className="px-6 py-12 text-center text-white md:px-12">
                        ...
                        BERLIN, March 16 (Reuters) - BMW cut its car division's 2022 profit margin forecast on Wednesday and said it expected the chip crisis to drag on throughout the year, the latest automaker to warn of supply chain disruptions exacerbated by Russia's invasion of Ukraine.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="w-full shrink-0 grow-0 basis-auto md:px-6 lg:w-7/12">
              <div className="mb-12 flex">
                <div className="shrink-0">
                  <div className="rounded-md bg-[#ff5030] p-4 shadow-lg dark:bg-[hsl(204,23%,30%)]">
                    <svg
